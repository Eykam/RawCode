...
def main():
    data = {
        "1" : "./data/hpctoolkit-lulesh2.0-database-1358383",
        "8" : "./data/hpctoolkit-lulesh2.0-database-1358387",
        "27" : "./data/hpctoolkit-lulesh2.0-database-1358390"
    }
    ...
    plt.savefig("./images/task3_bar.png")
  
    plt.figure(1)
    df.loc[:,:].plot.line(stacked=True, figsize=(15,15))
    plt.legend(ncols=2,fontsize="medium",loc="best")
    plt.savefig("./images/task3_line.png")
    plt.show()
