...
{
  double start, end;
  double start1, end1, time_pragma, time_simulation, time_integration, time_freeing, time_second, time_init;
...
end1  = omp_get_wtime();
time_simulation = end1-start1;


double start2, end2;
double time_firstloop = 0.0;
double time_svmp = 0.0;
double time_secondloop = 0.0;
start1 = omp_get_wtime();
/* --------------------------------------------------Time integration loop------------------------------------------------------------ */
  ...
  double measuredTotal = time_pragma + time_freeing + time_integration + time_simulation + time_second + time_init;

  printf("----Integration Time firstLoop  %.2f %\n", time_firstloop/time_integration * 100);
  printf("----Integration Time svmp  %.2f %\n", time_svmp/time_integration * 100);
  printf("----Integration Time secondLoop  %.2f %\n\n", time_secondloop/time_integration * 100);

  printf("Time init %.2f %\n", time_init/measuredTotal * 100);
  printf("Time pragma %.2f % \n", time_pragma/measuredTotal * 100);
  printf("Time second %.2f % \n", time_second/measuredTotal * 100);
  printf("Time simulation %.2f %\n", time_simulation/measuredTotal * 100);
  printf("Time integration %.2f %\n", time_integration/measuredTotal * 100);
  printf("Time freeing %.2f %\n", time_freeing/measuredTotal * 100);

  printf("Proportion Measured %.2f %\n", measuredTotal/(end-start) * 100);
  printf("Above total %.5f s\n", measuredTotal);
